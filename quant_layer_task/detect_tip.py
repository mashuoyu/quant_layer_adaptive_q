...
def run():
    ...
    parser.add_argument("-ad","--adnet_path",dest="ad_net_paths",type=str,nargs="*",default="/home/gujicheng/msy/checkpoint/cxt_model/rate_point_2/loss_clic_tip_300/checkpoint_best_loss.pth.tar",help="adnet paths")
