...
def detect_directory(model_path, compress_model, adnet, weights_path, img_path, classes, output_path,
...
def detect_image(model, image, img_size=448, conf_thres=0.5, nms_thres=0.5):
...
def detect(model, compressmodel,adnet, dataloader, output_path, conf_thres, nms_thres):
...
def run():
    ...
    parser.add_argument("-ad","--adnet_path",dest="ad_net_paths",type=str,nargs="*",default="/home/gujicheng/msy/checkpoint/cxt_model/rate_point_2/loss_clic_vid_300/checkpoint_best_loss.pth.tar",help="adnet paths")
    ...
    ad_net=Adaptive_q_embedded(192)
