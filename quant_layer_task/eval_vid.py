...
def _evaluate(model, compressmodel,adnet, dataloader, class_names, img_size, iou_thres, conf_thres, nms_thres, verbose):
    ...
    for _, imgs, targets in tqdm.tqdm(dataloader, desc="Validating"):
        ...
        with torch.no_grad():
            out_net_com = compressmodel.get_compression_vid(imgs,False)
...
def run():
    ...
    parser.add_argument("-ad","--adnet_path",dest="ad_net_paths",type=str,nargs="*",default="/home/gujicheng/msy/checkpoint/cxt_model/rate_point_2/loss_clic_vid_400/checkpoint_best_loss.pth.tar",help="adnet paths")
